...
//nvc++ -ta=tesla AN_network_efficacy_cav.cu -I/opt/nvidia/hpc_sdk/Linux_x86_64/23.3/examples/OpenACC/SDK/include/ -I/tmp/nvhpc_2023_233_Linux_x86_64_cuda_multi/install_components/Linux_x86_64/23.3/math_libs/12.0/targets/x86_64-linux/include -L/tmp/nvhpc_2023_233_Linux_x86_64_cuda_multi/install_components/Linux_x86_64/23.3/math_libs/12.0/targets/x86_64-linux/lib -lcudart -std=c++20 -o AN_net_effi_cav
...
// #define g_nmdar_lr 0.014
// #define g_cav_s_lr 0.050
// #define s_a_nmdar_lr 5 
// #define s_tau_nmdar_lr 10
// #define x_a_nmdar_lr 34.8
// #define x_tau_nmdar_lr 0.2
...
__global__ void dt_gpu_NaK1_n(double *v,  double *h_na, double *nk, double *h, double *m, double *ca, double *s_a, double *s_a2, double *s_a3, double *s_g, double *s_g2, double *s_g3,
                    ...
                    double g_leak, double g_nav,double g_kvhh,double g_kva, double g_kvsi,double g_cav_lr, double g_cav,double g_kca, double g_nap, double g_kir, double g_ampar, double g_nmdar ,double g_gabar, double tau_ca,
                    double cpre_r, double cpost_r, double th_p, double th_d, double gp, double gd, double tau_ca_pre, double tau_ca_post, double sig, double tau_s)
{
  ...
  for(int it=0; it<T; it++){
    ...
    {  
        ...
        double i_vdcc_i = i_vdcc(g_cav_lr, v_n);
...
int main(int argc, char * argv[]){
    ...
    double g_leak,g_nav,g_kvhh, g_kva, g_kvsi,g_cav_ori,g_nap,g_kca, g_kir, g_ampar, g_nmdar, g_gabar, tau_ca;
    ...
    double ex_lr = atof(argv[g_c]);
    std::string ex_lr_str= argv[g_c];
    g_c +=1;
    ...
    #elif defined(CAV)
        double g_cav_lr = g_cav_ori* (std::pow(10, ex_lr));
   ...
   int b_neuron2 = sizeof(double)*(NE+NI);
    ...
    //  if (it != 0){
            ...
            dt_gpu_NaK1_n<<<grid, block>>>(d_v, d_h_na, d_nk, d_h, d_m, d_ca, d_s_a, d_s_a2, d_s_a3,d_s_g, d_s_g2, d_s_g3, 
                            ...
                            g_leak, g_nav, g_kvhh, g_kva, g_kvsi, g_cav_lr, g_cav,g_kca, g_nap,g_kir, g_ampar, g_nmdar, g_gabar,tau_ca,
