...
//nvc++ -mp -fast -ta=tesla AN_network_crw.cu -I/opt/nvidia/hpc_sdk/Linux_x86_64/23.3/examples/OpenACC/SDK/include/ -I/tmp/nvhpc_2023_223_Linux_x86_64_cuda_multi/install_components/Linux_x86_64/23.3/math_libs/12.0/targets/x86_64-linux/include -L/tmp/nvhpc_2023_223_Linux_x86_64_cuda_multi/install_components/Linux_x86_64/23.3/math_libs/12.0/targets/x86_64-linux/lib -lcudart -std=c++20 -o AN_net_crw_nmdar
//nvc++ -mp -fast -ta=tesla AN_network_crw.cu -I/opt/nvidia/hpc_sdk/Linux_x86_64/23.3/examples/OpenACC/SDK/include/ -I/tmp/nvhpc_2023_223_Linux_x86_64_cuda_multi/install_components/Linux_x86_64/23.3/math_libs/12.0/targets/x86_64-linux/include -L/tmp/nvhpc_2023_223_Linux_x86_64_cuda_multi/install_components/Linux_x86_64/23.3/math_libs/12.0/targets/x86_64-linux/lib -lcudart -std=c++20 -o AN_net_crw_cav
...
//ds4
//nvc++ -ta=tesla AN_network_crw.cu -I/opt/nvidia/hpc_sdk/Linux_x86_64/23.3/examples/OpenACC/SDK/include/ -I/tmp/nvhpc_2023_233_Linux_x86_64_cuda_multi/install_components/Linux_x86_64/23.3/math_libs/12.0/targets/x86_64-linux/include -L/tmp/nvhpc_2023_233_Linux_x86_64_cuda_multi/install_components/Linux_x86_64/23.3/math_libs/12.0/targets/x86_64-linux/lib -lcudart -std=c++20 -o AN_net_crw_cav
//nvc++ -ta=tesla AN_network_crw.cu -I/opt/nvidia/hpc_sdk/Linux_x86_64/23.3/examples/OpenACC/SDK/include/ -I/tmp/nvhpc_2023_233_Linux_x86_64_cuda_multi/install_components/Linux_x86_64/23.3/math_libs/12.0/targets/x86_64-linux/include -L/tmp/nvhpc_2023_233_Linux_x86_64_cuda_multi/install_components/Linux_x86_64/23.3/math_libs/12.0/targets/x86_64-linux/lib -lcudart -std=c++20 -o AN_net_crw_nmdar
...
__global__ void dt_gpu_NaK1_n(double *v,  double *h_na, double *nk, double *h, double *m, double *ca, double *s_a, double *s_a2, double *s_a3, double *s_g, double *s_g2, double *s_g3,
                    ...
                    double cpre_r, double cpost_r, double tau_ca_pre, double tau_ca_post)
{
   ...
   int b_neuron2 = sizeof(double)*(NE+NI);
    ...
    //  if (it != 0){
            ...
            dt_gpu_NaK1_n<<<grid, block>>>(d_v, d_h_na, d_nk, d_h, d_m, d_ca, d_s_a, d_s_a2, d_s_a3,d_s_g, d_s_g2, d_s_g3, 
                            ...
                            cpre_r, cpost_r, tau_ca_pre, tau_ca_post);
        ...
        for (int i = 0; i < (NE+NI); i++) {
         ...
         if (tb==tboff-1){
        int ret;
        // std::string crw_str = "./c_r_w_ca "+ g_nmdar_str +" "+g_cav_str+" "+cpre_r_str+" "+cpost_r_str+" " + tau_ca_pre_str+" " +tau_ca_post_str + " "+
    ...
    //     ret1= std::system(crw_str.c_str());
    //  std::cout <<  crw_str <<"ret1/cpp = " << ret1 << std::endl;
