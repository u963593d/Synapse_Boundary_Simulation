...
import numpy as np
import pandas as pd
#python3 make_effi_sh_seed.py STDP a0.7t50 0 None GPU r
    ...
    #         print(lr_li[l])
        ...
        with open(savetxt_w, "w") as f:
            ...
            for i in range(len(pd_params)):
                ...
                file1 = th_p_s + " " + th_d_s + " " + gp_s + " " + gd_s + " " + tau_pre_s + " " + tau_post_s + " " + sig_s + " " + tau_s_s + " " + lr + " " + order +  args0 + " "+order + args1
                # print(file1)

                f.write(file1+'\n')                         

    param_f = lr+"_"+lr_p + "_seed.sh"
